...
<html>
    <head>
        ...
        <!-- jvectormap -->
        <link rel="stylesheet" type="text/css" href="<?php echo base_url() . "assets/"; ?>bower_components/jvectormap/jquery-jvectormap.css">
        <!-- Theme style -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy;2019 SiGE.</strong>                                
                <p>Feito com <a href="https://adminlte.io">AdminLTE 2.4.7</a> e  <?php echo (ENVIRONMENT === 'development') ? 'CodeIgniter Version <strong>' . CI_VERSION . '</strong>' : '' ?></p>
