...
<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-mini"><b><?php echo substr($titulo, 0, 2); ?></b><?php echo substr($titulo, 2, 4); ?></span>
        <!-- logo for regular state and mobile devices -->                    
        <span class="logo-lg"><b><?php echo substr($titulo, 0, 2); ?></b><?php echo substr($titulo, 2, 4); ?></span>
    </a>
